const stringToDouble = (string) => {
    ...
    if (string === undefined) {
        throw 'you need to enter the amount of gold you sent, e.g. "!logdonation 500"'
    } else if (isNaN(double)) {
        throw 'you entered something that wasnt a number, please use something like this: "!logdonation 500"';
    } else {
        return double;
    }
}
